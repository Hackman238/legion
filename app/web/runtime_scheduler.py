...
truncate_scheduler_text = web_runtime_scheduler_context.truncate_scheduler_text
scheduler_output_lines = web_runtime_scheduler_context.scheduler_output_lines
scheduler_line_signal_score = web_runtime_scheduler_context.scheduler_line_signal_score
build_scheduler_excerpt = web_runtime_scheduler_context.build_scheduler_excerpt
build_scheduler_prompt_excerpt = web_runtime_scheduler_context.build_scheduler_prompt_excerpt
build_scheduler_analysis_excerpt = web_runtime_scheduler_context.build_scheduler_analysis_excerpt
scheduler_tool_alias_tokens = web_runtime_scheduler_context.scheduler_tool_alias_tokens
extract_unavailable_tool_tokens = web_runtime_scheduler_context.extract_unavailable_tool_tokens
extract_missing_nse_script_tokens = web_runtime_scheduler_context.extract_missing_nse_script_tokens
looks_like_local_tool_dependency_failure = web_runtime_scheduler_context.looks_like_local_tool_dependency_failure
scheduler_banner_from_evidence = web_runtime_scheduler_context.scheduler_banner_from_evidence
scheduler_service_banner_fallback = web_runtime_scheduler_context.scheduler_service_banner_fallback
...
read_text_excerpt = web_runtime_scheduler_execution.read_text_excerpt
get_scheduler_execution_traces = web_runtime_scheduler_execution.get_scheduler_execution_traces
get_scheduler_execution_trace = web_runtime_scheduler_execution.get_scheduler_execution_trace
approve_scheduler_approval = web_runtime_scheduler_execution.approve_scheduler_approval
reject_scheduler_approval = web_runtime_scheduler_execution.reject_scheduler_approval
persist_scheduler_execution_record = web_runtime_scheduler_execution.persist_scheduler_execution_record
execute_approved_scheduler_item = web_runtime_scheduler_execution.execute_approved_scheduler_item
execute_scheduler_decision = web_runtime_scheduler_execution.execute_scheduler_decision
...
persist_scheduler_ai_analysis = web_runtime_scheduler_state.persist_scheduler_ai_analysis
persist_scheduler_reflection_analysis = web_runtime_scheduler_state.persist_scheduler_reflection_analysis
apply_ai_host_updates = web_runtime_scheduler_state.apply_ai_host_updates
enrich_host_from_observed_results = web_runtime_scheduler_state.enrich_host_from_observed_results
queue_scheduler_approval = web_runtime_scheduler_state.queue_scheduler_approval
record_scheduler_decision = web_runtime_scheduler_state.record_scheduler_decision
build_scheduler_credential_row = web_runtime_scheduler_state.build_scheduler_credential_row
build_scheduler_session_row = web_runtime_scheduler_state.build_scheduler_session_row
extract_credential_capture_entries = web_runtime_scheduler_state.extract_credential_capture_entries
persist_credential_captures_to_scheduler = web_runtime_scheduler_state.persist_credential_captures_to_scheduler
persist_credential_capture_output = web_runtime_scheduler_state.persist_credential_capture_output
is_placeholder_scheduler_text = web_runtime_scheduler_state.is_placeholder_scheduler_text
infer_technologies_from_observations = web_runtime_scheduler_state.infer_technologies_from_observations
infer_host_technologies = web_runtime_scheduler_state.infer_host_technologies
normalize_ai_technologies = web_runtime_scheduler_state.normalize_ai_technologies
merge_technologies = web_runtime_scheduler_state.merge_technologies
infer_findings_from_observations = web_runtime_scheduler_state.infer_findings_from_observations
infer_host_findings = web_runtime_scheduler_state.infer_host_findings
infer_urls_from_observations = web_runtime_scheduler_state.infer_urls_from_observations
infer_host_urls = web_runtime_scheduler_state.infer_host_urls
normalize_ai_findings = web_runtime_scheduler_state.normalize_ai_findings
normalize_ai_manual_tests = web_runtime_scheduler_state.normalize_ai_manual_tests
merge_ai_items = web_runtime_scheduler_state.merge_ai_items
coverage_gaps_from_summary = web_runtime_scheduler_state.coverage_gaps_from_summary
persist_shared_target_state = web_runtime_scheduler_state.persist_shared_target_state
load_host_ai_analysis = web_runtime_scheduler_state.load_host_ai_analysis
scan_history_targets = web_runtime_scheduler_state.scan_history_targets
